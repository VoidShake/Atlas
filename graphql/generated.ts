...
export type GetLocationDraftsQuery = {
   __typename?: 'Query'
   connection: {
      __typename?: 'LocationDraftConnection'
      totalCount: any
...
export type GetLocationDraftQuery = {
   __typename?: 'Query'
   locationDraft: {
      __typename?: 'LocationDraft'
      id: number
...
export const GetLocationDraftsDocument = {
   kind: 'Document',
   definitions: [
      {
         kind: 'OperationDefinition',
         operation: 'query',
         name: { kind: 'Name', value: 'getLocationDrafts' },
         variableDefinitions: [
            {
               kind: 'VariableDefinition',
            ...
            selections: [
               {
                  ...
                  name: { kind: 'Name', value: 'locationDrafts' },
                  arguments: [
                     {
                        kind: 'Argument',
...
} as unknown as DocumentNode<GetLocationDraftsQuery, GetLocationDraftsQueryVariables>
export const GetLocationDraftDocument = {
   kind: 'Document',
   definitions: [
      {
         kind: 'OperationDefinition',
         operation: 'query',
         name: { kind: 'Name', value: 'getLocationDraft' },
         variableDefinitions: [
            {
               kind: 'VariableDefinition',
         ...
         selectionSet: {
            ...
            selections: [
               {
                  kind: 'Field',
                  alias: { kind: 'Name', value: 'locationDraft' },
   ...
   definitions: [
      {
         ...
         variableDefinitions: [
            ...
            {
               kind: 'VariableDefinition',
               variable: { kind: 'Variable', name: { kind: 'Name', value: 'locations' } },
               type: {
                  kind: 'ListType',
                  type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'Int' } } },
               },
