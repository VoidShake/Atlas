...
export type GetLocationQuery = {
   ...
   location: {
      ...
      tales: {
         __typename?: 'TaleList'
         totalCount: any
         nodes: Array<{ __typename?: 'Tale'; title: string; text: string }>
      }
      pos: { __typename?: 'Point'; x: number; y?: number | null; z: number }
   }
}
...
export type GetTalesQuery = {
   ...
   tales: {
      __typename?: 'TaleList'
      totalCount: any
      nodes: Array<{ __typename?: 'Tale'; id: number; title: string }>
   }
}
...
export type GetTaleQuery = {
   __typename?: 'Query'
   tale: { __typename?: 'Tale'; text: string; id: number; title: string }
}
         ...
         variableDefinitions: [
            {
               ...
               type: {
                  ...
                  type: {
                     kind: 'NamedType',
                     name: { kind: 'Name', value: 'CreateTaleInput' },
                  },
               },
            },
            {
