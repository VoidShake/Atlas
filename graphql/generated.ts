...
export type GetLocationsQuery = { __typename?: 'Query', locations: { __typename?: 'LocationConnection', totalCount: any, nodes: Array<{ __typename?: 'Location', slug: string, id: number, name: string, pos: { __typename?: 'Point', x: number, y?: number | null, z: number } }> } };
...
type Lore_Tale_Fragment = { __typename?: 'Tale', text: string, id: number, title: string, locations: { __typename?: 'LocationConnection', totalCount: any, nodes: Array<{ __typename?: 'Location', slug: string, id: number, name: string, pos: { __typename?: 'Point', x: number, y?: number | null, z: number } }> } };

type Lore_TaleDraft_Fragment = { __typename?: 'TaleDraft', text: string, id: number, title: string, locations: { __typename?: 'LocationConnection', totalCount: any, nodes: Array<{ __typename?: 'Location', slug: string, id: number, name: string, pos: { __typename?: 'Point', x: number, y?: number | null, z: number } }> } };
